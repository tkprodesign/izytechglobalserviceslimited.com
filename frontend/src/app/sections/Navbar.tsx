...
const navLinks: NavLink[] = [
  { label: "Home",         to: "/" },
  {
    ...
    to: "/services",
    children: [
      { label: "Solar Energy Systems",    to: "/services#service-solar-energy-systems" },
      { label: "Industrial Wiring",       to: "/services#service-industrial-wiring" },
      { label: "Smart Home Automation",   to: "/services#service-smart-home-automation" },
      { label: "CCTV & Security",         to: "/services#service-cctv-security" },
      { label: "IT & Tech Services",      to: "/services#service-it-tech-services" },
    ],
  },
