...
const FALLBACK: Testimonial[] = [
  ...
  {
    id: 2,
    name: "Mrs Helen Douye Miebi",
    role: "CEO",
    company: "Nigeria",
    text: "We hired Izy Tech Services to power our school with solar and upgrade our entire IT infrastructure. They delivered on time and on budget. 40 classrooms, our computer labs and the admin block now run 24/7 without a single interruption.",
    rating: 5,
    avatar: "HM",
  ...
  {
    id: 3,
    name: "Mrs Dominica Onyia",
    role: "Facilities Manager",
    company: "Port Harcourt",
    text: "The CCTV and smart security system Izy Tech Services installed across our hotel has transformed how we manage safety. 128 cameras, smart locks, all controlled from one dashboard. Truly world-class work.",
    rating: 5,
    avatar: "DO",
