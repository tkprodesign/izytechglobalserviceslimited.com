        ...
        <div className="max-w-7xl mx-auto px-6 py-20 lg:py-28">
          ...
          >
            ...
            <p className="text-white/45 max-w-xl text-base leading-relaxed" style={{ fontFamily: "var(--font-body)" }}>
              From solar energy to smart automation, industrial wiring to IT infrastructure — <span className="whitespace-nowrap">Izy Tech Services</span> is your single partner for every energy and technology need.
            </p>
          </motion.div>
        </div>
      </div>
